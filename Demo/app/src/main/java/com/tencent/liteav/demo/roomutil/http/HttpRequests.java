...
public class HttpRequests {
    ...
    public void getPushUrl(String userID, String roomID, OnResponseCallback<HttpResponse.PushUrl> callback){
        ...
        Request request = new Request.Builder().url(getRequestUrl("/get_push_url"))
                .post(RequestBody.create(MEDIA_JSON, body))
                .build();
    ...
    public void getPushers(String roomId, final OnResponseCallback<HttpResponse.PusherList> callback){
        ...
        Request request = new Request.Builder().url(getRequestUrl("/get_pushers"))
                .post(RequestBody.create(MEDIA_JSON, body))
                .build();
    ...
    public void addPusher(String roomID, String userID,
        ...
        Request request = new Request.Builder().url(getRequestUrl("/add_pusher"))
                .post(RequestBody.create(MEDIA_JSON, body))
                .build();
    ...
    public void delPusher(String roomID, String userID,
        ...
        Request request = new Request.Builder().url(getRequestUrl("/delete_pusher"))
                .post(RequestBody.create(MEDIA_JSON, body))
                .build();
    ...
    public void setCustomInfo(String roomID, String fieldName,
                          String  operation, int count, final OnResponseCallback<HttpResponse> callback){
        String body = "";
        try {
            body = new JsonBuilder()
                    .put("roomID", roomID)
    ...
    public boolean heartBeat(String user_id, String room_id){
        ...
        Request request = new Request.Builder().url(getRequestUrl("/pusher_heartbeat"))
                .post(RequestBody.create(MEDIA_JSON, body))
                .build();
    ...
    public void login(long sdkAppID, String accountType, String userID, String userSig, final OnResponseCallback<HttpResponse.LoginResponse> callback) {
        try {
            String body = "";
            Request request = new Request.Builder().url(domain.concat("/login").concat(String.format("?sdkAppID=%s&accountType=%s&userID=%s&userSig=%s", String.valueOf(sdkAppID), accountType, userID, userSig)))
                    .post(RequestBody.create(MEDIA_JSON, body))
                    .build();

            request(request, HttpResponse.LoginResponse.class, callback);
        }
        catch (Exception e) {
            callback.onResponse(-1, e.getMessage(), null);
        }
