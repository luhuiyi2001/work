...
//            );
//            sReference = new WeakReference<Snackbar>(Snackbar.make(view, spannableString, duration));
//        } else {
//            sReference = new WeakReference<Snackbar>(Snackbar.make(view, message, duration));
//        }
