...
//        );
        ...
        QMUITabSegment.Tab stats = new QMUITabSegment.Tab(
    ...
    private void initPagers() {
        ...
        HomeController homeStatsController = new HomeStatsController(getActivity());
        homeStatsController.setHomeControlListener(listener);
        mPages.put(Pager.STATS, homeStatsController);
