...
public class CountStatAdapter extends BaseAdapter {
    private Context mContext;
    private List<CountStatic> mData;

    public CountStatAdapter(Context context, List<CountStatic> data) {
        mContext = context;
        mData = data;
    }

    public void setData(List<CountStatic> data) {
        mData = data;
    }
    ...
    static class ItemView extends FrameLayout {
        ...
        public ItemView(Context context) {
            ...
            int paddingHor = QMUIDisplayHelper.dp2px(context, 0);
            int paddingVer = QMUIDisplayHelper.dp2px(context, 0);
            ...
            int paddingTvHor = QMUIDisplayHelper.dp2px(context, 0);
